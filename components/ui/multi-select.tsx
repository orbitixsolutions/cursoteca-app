...
type MultiSelectTriggerProps = React.ComponentPropsWithoutRef<typeof Primitive.div>
...
>(({ className, children, ...props }, forwardedRef) => {
   ...
   return (
      <PopoverPrimitive.Trigger ref={forwardedRef as never} asChild>
         <div
...
type MultiSelectContentProps = React.ComponentPropsWithoutRef<typeof PopoverPrimitive.Content>
